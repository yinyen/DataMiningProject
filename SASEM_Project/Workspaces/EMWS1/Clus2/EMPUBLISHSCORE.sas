...
array CLUS2vads [2] _temporary_;
drop _vqclus _vqmvar _vqnvar;
_vqmvar = 0;
do _vqclus = 1 to 2; CLUS2vads [_vqclus] = 0; end;
if not missing( T_IMP_domestic_gross ) then do;
   CLUS2vads [1] + ( T_IMP_domestic_gross - 2.87220794248178 )**2;
   CLUS2vads [2] + ( T_IMP_domestic_gross - -0.1896385655071 )**2;
end;
else _vqmvar + 1;
if not missing( T_IMP_domestic_opening ) then do;
   CLUS2vads [1] + ( T_IMP_domestic_opening - 2.73482456067058 )**2;
   CLUS2vads [2] + ( T_IMP_domestic_opening - -0.18056777816408 )**2;
end;
else _vqmvar + 1;
if not missing( T_IMP_foreign_gross ) then do;
   CLUS2vads [1] + ( T_IMP_foreign_gross - 2.94640159873994 )**2;
   CLUS2vads [2] + ( T_IMP_foreign_gross - -0.19453722842576 )**2;
end;
else _vqmvar + 1;
if not missing( T_IMP_runtime ) then do;
   CLUS2vads [1] + ( T_IMP_runtime - 0.76006399735459 )**2;
   CLUS2vads [2] + ( T_IMP_runtime - -0.0501834996067 )**2;
end;
else _vqmvar + 1;
if not missing( T_IMP_ss_count ) then do;
   CLUS2vads [1] + ( T_IMP_ss_count - 2.08974692011831 )**2;
   CLUS2vads [2] + ( T_IMP_ss_count - -0.1379762942448 )**2;
end;
else _vqmvar + 1;
if not missing( T_IMP_ss_mean ) then do;
   CLUS2vads [1] + ( T_IMP_ss_mean - 0.00219753251188 )**2;
   CLUS2vads [2] + ( T_IMP_ss_mean - -0.00014509287681 )**2;
end;
else _vqmvar + 1;
if not missing( T_IMP_ss_median ) then do;
   CLUS2vads [1] + ( T_IMP_ss_median - 0.08474213874912 )**2;
   CLUS2vads [2] + ( T_IMP_ss_median - -0.00559513028033 )**2;
end;
else _vqmvar + 1;
if not missing( T_IMP_ss_p25 ) then do;
   CLUS2vads [1] + ( T_IMP_ss_p25 - -0.10760457461597 )**2;
   CLUS2vads [2] + ( T_IMP_ss_p25 - 0.00710463085571 )**2;
end;
else _vqmvar + 1;
if not missing( T_IMP_ss_p75 ) then do;
   CLUS2vads [1] + ( T_IMP_ss_p75 - 0.08734983522566 )**2;
   CLUS2vads [2] + ( T_IMP_ss_p75 - -0.00576730438088 )**2;
end;
else _vqmvar + 1;
if not missing( T_IMP_ss_std ) then do;
   CLUS2vads [1] + ( T_IMP_ss_std - 0.06803752640285 )**2;
   CLUS2vads [2] + ( T_IMP_ss_std - -0.00449220222423 )**2;
end;
else _vqmvar + 1;
if not missing( T_IMP_total_gross ) then do;
   CLUS2vads [1] + ( T_IMP_total_gross - 3.00835883460645 )**2;
   CLUS2vads [2] + ( T_IMP_total_gross - -0.19862797727397 )**2;
end;
else _vqmvar + 1;
if not missing( T_IMP_user_rating_count ) then do;
   CLUS2vads [1] + ( T_IMP_user_rating_count - 2.28535453929982 )**2;
   CLUS2vads [2] + ( T_IMP_user_rating_count - -0.15089135786369 )**2;
end;
else _vqmvar + 1;
if not missing( T_tomatometer_count ) then do;
   CLUS2vads [1] + ( T_tomatometer_count - 2.08540151398664 )**2;
   CLUS2vads [2] + ( T_tomatometer_count - -0.13768938723742 )**2;
end;
else _vqmvar + 1;
if not missing( G0 ) then do;
   CLUS2vads [1] + ( G0 - -0.03543197652852 )**2;
   CLUS2vads [2] + ( G0 - 0.00233940903183 )**2;
end;
else _vqmvar + 0.5;
if not missing( G1 ) then do;
   CLUS2vads [1] + ( G1 - 0.03543197652852 )**2;
   CLUS2vads [2] + ( G1 - -0.00233940903183 )**2;
end;
else _vqmvar + 0.5;
if not missing( IMP_markets_missing0 ) then do;
   CLUS2vads [1] + ( IMP_markets_missing0 - 0.79211309335049 )**2;
   CLUS2vads [2] + ( IMP_markets_missing0 - -0.05229955273105 )**2;
end;
else _vqmvar + 0.5;
if not missing( IMP_markets_missing1 ) then do;
   CLUS2vads [1] + ( IMP_markets_missing1 - -0.79211309335049 )**2;
   CLUS2vads [2] + ( IMP_markets_missing1 - 0.05229955273105 )**2;
end;
else _vqmvar + 0.5;
if not missing( NR0 ) then do;
   CLUS2vads [1] + ( NR0 - 0.57998709164538 )**2;
   CLUS2vads [2] + ( NR0 - -0.03829385694729 )**2;
end;
else _vqmvar + 0.5;
if not missing( NR1 ) then do;
   CLUS2vads [1] + ( NR1 - -0.57998709164538 )**2;
   CLUS2vads [2] + ( NR1 - 0.03829385694729 )**2;
end;
else _vqmvar + 0.5;
if not missing( PG0 ) then do;
   CLUS2vads [1] + ( PG0 - -0.61865063810695 )**2;
   CLUS2vads [2] + ( PG0 - 0.04084663154969 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( PG1 ) then do;
   CLUS2vads [1] + ( PG1 - 0.61865063810695 )**2;
   CLUS2vads [2] + ( PG1 - -0.04084663154969 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( PG_130 ) then do;
   CLUS2vads [1] + ( PG_130 - -0.62115673853124 )**2;
   CLUS2vads [2] + ( PG_130 - 0.04101209773424 )**2;
end;
else _vqmvar + 0.5;
if not missing( PG_131 ) then do;
   CLUS2vads [1] + ( PG_131 - 0.62115673853124 )**2;
   CLUS2vads [2] + ( PG_131 - -0.04101209773424 )**2;
end;
else _vqmvar + 0.5;
if not missing( R0 ) then do;
   CLUS2vads [1] + ( R0 - 0.19776751254202 )**2;
   CLUS2vads [2] + ( R0 - -0.01305767135716 )**2;
end;
else _vqmvar + 0.5;
if not missing( R1 ) then do;
   CLUS2vads [1] + ( R1 - -0.19776751254202 )**2;
   CLUS2vads [2] + ( R1 - 0.01305767135716 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Action0 ) then do;
   CLUS2vads [1] + ( genre_Action0 - -0.80089532919418 )**2;
   CLUS2vads [2] + ( genre_Action0 - 0.05287940302068 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( genre_Action1 ) then do;
   CLUS2vads [1] + ( genre_Action1 - 0.80089532919418 )**2;
   CLUS2vads [2] + ( genre_Action1 - -0.05287940302068 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( genre_Adventure0 ) then do;
   CLUS2vads [1] + ( genre_Adventure0 - -0.80408743395136 )**2;
   CLUS2vads [2] + ( genre_Adventure0 - 0.05309016288878 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Adventure1 ) then do;
   CLUS2vads [1] + ( genre_Adventure1 - 0.80408743395136 )**2;
   CLUS2vads [2] + ( genre_Adventure1 - -0.05309016288878 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_AnimationManga0 ) then do;
   CLUS2vads [1] + ( genre_AnimationManga0 - -0.67164096245467 )**2;
   CLUS2vads [2] + ( genre_AnimationManga0 - 0.04434533683019 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_AnimationManga1 ) then do;
   CLUS2vads [1] + ( genre_AnimationManga1 - 0.67164096245467 )**2;
   CLUS2vads [2] + ( genre_AnimationManga1 - -0.04434533683019 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_ArthouseInter0 ) then do;
   CLUS2vads [1] + ( genre_ArthouseInter0 - 0.20055942220462 )**2;
   CLUS2vads [2] + ( genre_ArthouseInter0 - -0.01324200819978 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_ArthouseInter1 ) then do;
   CLUS2vads [1] + ( genre_ArthouseInter1 - -0.20055942220462 )**2;
   CLUS2vads [2] + ( genre_ArthouseInter1 - 0.01324200819978 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_ClassicsCult0 ) then do;
   CLUS2vads [1] + ( genre_ClassicsCult0 - 0.05924108200796 )**2;
   CLUS2vads [2] + ( genre_ClassicsCult0 - -0.00391141380988 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_ClassicsCult1 ) then do;
   CLUS2vads [1] + ( genre_ClassicsCult1 - -0.05924108200796 )**2;
   CLUS2vads [2] + ( genre_ClassicsCult1 - 0.00391141380988 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Comedy0 ) then do;
   CLUS2vads [1] + ( genre_Comedy0 - -0.06133706785003 )**2;
   CLUS2vads [2] + ( genre_Comedy0 - 0.0040498020312 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Comedy1 ) then do;
   CLUS2vads [1] + ( genre_Comedy1 - 0.06133706785003 )**2;
   CLUS2vads [2] + ( genre_Comedy1 - -0.0040498020312 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_DramaTele0 ) then do;
   CLUS2vads [1] + ( genre_DramaTele0 - 0.21599159228418 )**2;
   CLUS2vads [2] + ( genre_DramaTele0 - -0.0142609227962 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_DramaTele1 ) then do;
   CLUS2vads [1] + ( genre_DramaTele1 - -0.21599159228418 )**2;
   CLUS2vads [2] + ( genre_DramaTele1 - 0.0142609227962 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_FamilyKids0 ) then do;
   CLUS2vads [1] + ( genre_FamilyKids0 - -0.72772205483865 )**2;
   CLUS2vads [2] + ( genre_FamilyKids0 - 0.04804811118523 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_FamilyKids1 ) then do;
   CLUS2vads [1] + ( genre_FamilyKids1 - 0.72772205483865 )**2;
   CLUS2vads [2] + ( genre_FamilyKids1 - -0.04804811118523 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Fantasy0 ) then do;
   CLUS2vads [1] + ( genre_Fantasy0 - -0.89925733001411 )**2;
   CLUS2vads [2] + ( genre_Fantasy0 - 0.0593737896074 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Fantasy1 ) then do;
   CLUS2vads [1] + ( genre_Fantasy1 - 0.89925733001411 )**2;
   CLUS2vads [2] + ( genre_Fantasy1 - -0.0593737896074 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_FitnessSports0 ) then do;
   CLUS2vads [1] + ( genre_FitnessSports0 - 0.06746193464646 )**2;
   CLUS2vads [2] + ( genre_FitnessSports0 - -0.00445419857088 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_FitnessSports1 ) then do;
   CLUS2vads [1] + ( genre_FitnessSports1 - -0.06746193464646 )**2;
   CLUS2vads [2] + ( genre_FitnessSports1 - 0.00445419857088 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_HistDocument0 ) then do;
   CLUS2vads [1] + ( genre_HistDocument0 - 0.31132617810331 )**2;
   CLUS2vads [2] + ( genre_HistDocument0 - -0.02055542321539 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_HistDocument1 ) then do;
   CLUS2vads [1] + ( genre_HistDocument1 - -0.31132617810331 )**2;
   CLUS2vads [2] + ( genre_HistDocument1 - 0.02055542321539 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Horror0 ) then do;
   CLUS2vads [1] + ( genre_Horror0 - 0.02833963218366 )**2;
   CLUS2vads [2] + ( genre_Horror0 - -0.00187113443801 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Horror1 ) then do;
   CLUS2vads [1] + ( genre_Horror1 - -0.02833963218366 )**2;
   CLUS2vads [2] + ( genre_Horror1 - 0.00187113443801 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_MusicalPerfarts0 ) then do;
   CLUS2vads [1] + ( genre_MusicalPerfarts0 - -0.03673373173265 )**2;
   CLUS2vads [2] + ( genre_MusicalPerfarts0 - 0.00242535788877 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( genre_MusicalPerfarts1 ) then do;
   CLUS2vads [1] + ( genre_MusicalPerfarts1 - 0.03673373173265 )**2;
   CLUS2vads [2] + ( genre_MusicalPerfarts1 - -0.00242535788877 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Romance0 ) then do;
   CLUS2vads [1] + ( genre_Romance0 - 0.08050208235456 )**2;
   CLUS2vads [2] + ( genre_Romance0 - -0.00531517902734 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Romance1 ) then do;
   CLUS2vads [1] + ( genre_Romance1 - -0.08050208235456 )**2;
   CLUS2vads [2] + ( genre_Romance1 - 0.00531517902734 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Sci_fi0 ) then do;
   CLUS2vads [1] + ( genre_Sci_fi0 - -0.9023041393562 )**2;
   CLUS2vads [2] + ( genre_Sci_fi0 - 0.0595749562933 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Sci_fi1 ) then do;
   CLUS2vads [1] + ( genre_Sci_fi1 - 0.9023041393562 )**2;
   CLUS2vads [2] + ( genre_Sci_fi1 - -0.0595749562933 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Special_Interest0 ) then do;
   CLUS2vads [1] + ( genre_Special_Interest0 - 0.20079923895056 )**2;
   CLUS2vads [2] + ( genre_Special_Interest0 - -0.01325784218694 )**2;
end;
else _vqmvar + 0.49999999999999;
if not missing( genre_Special_Interest1 ) then do;
   CLUS2vads [1] + ( genre_Special_Interest1 - -0.20079923895056 )**2;
   CLUS2vads [2] + ( genre_Special_Interest1 - 0.01325784218694 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_ThrillMysSusp0 ) then do;
   CLUS2vads [1] + ( genre_ThrillMysSusp0 - 0.11174879862142 )**2;
   CLUS2vads [2] + ( genre_ThrillMysSusp0 - -0.00737825474063 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_ThrillMysSusp1 ) then do;
   CLUS2vads [1] + ( genre_ThrillMysSusp1 - -0.11174879862142 )**2;
   CLUS2vads [2] + ( genre_ThrillMysSusp1 - 0.00737825474063 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Western0 ) then do;
   CLUS2vads [1] + ( genre_Western0 - -0.00052323235186 )**2;
   CLUS2vads [2] + ( genre_Western0 - 0.00003454660478 )**2;
end;
else _vqmvar + 0.5;
if not missing( genre_Western1 ) then do;
   CLUS2vads [1] + ( genre_Western1 - 0.00052323235186 )**2;
   CLUS2vads [2] + ( genre_Western1 - -0.00003454660478 )**2;
end;
else _vqmvar + 0.5;
_vqnvar = 37 - _vqmvar;
